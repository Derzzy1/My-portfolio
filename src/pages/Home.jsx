    ...
    <div className='mai'>
     <div className="fs1">
      <h1 className='n1'> Caleb </h1>
       ...
       <h1> Frontend developer crafting responsive, high-performance web apps with React and modern JavaScript. </h1>
       <h1>I don’t just build websites—I create experiences people enjoy using. </h1>
       <ul className='skills'>
       ...
       <button>
        <a href="/projects" className="gt">View Projects </a>
       </button>
       <button>
        <a href="/contacts"className="gt">Contact me</a>
       </button>
     </div>
     <div className="fs2">
